...
const lessons: Record<string, LessonCopy> = {
  ...
  "pie-chart": lesson(
    ...
    "Use it for a few non-negative categories whose total forms a meaningful whole.",
  ...
  "scatter-chart": lesson(
    "A relationship between two numeric measures, with every point independently named and positioned.",
    "Like pins on a map of effort and impact: nearby points share similar tradeoffs.",
    "Use it to reveal correlation, clusters, and outliers across two measurements.",
  ...
  "boxplot-chart": lesson(
    ...
    "Use it to compare spread, skew, and typical values across several groups.",
  ...
  "stacked-bar-chart": lesson(
    ...
    "Use it when long category labels and part-to-total comparisons both matter.",
  ...
  heatmap: lesson(
    ...
    "Use it to scan patterns across two categorical dimensions.",
    ...
    '<Heatmap values={contributions} xLabel="Week" yLabel="Weekday" valueLabel="Contributions">\n  <ChartTitle>Contribution activity</ChartTitle>\n  <HeatmapPlot aria-label="Contribution heatmap by weekday and week">\n    {(cell) => (\n      <HeatmapCell cell={cell}>\n        <rect x={cell.x} y={cell.y} width={cell.width} height={cell.height} />\n      </HeatmapCell>\n    )}\n  </HeatmapPlot>\n  <ChartTable>\n    <caption>Contributions by weekday and week</caption>\n  </ChartTable>\n  <ChartTooltip />\n</Heatmap>;',
  ),
  "sankey-chart": lesson(
    ...
    "Use it for journeys, transfers, energy, budgets, and other acyclic flows.",
    "Start SankeyChart with uniquely identified nodes and positive links between them.",
...
const chart = [
      ...
      p(
        ...
        [
          ...
          prop(
            "xLabel / yLabel",
            "string",
            "Visible headings for the horizontal and vertical axes.",
          ),
          prop(
            "formatX / formatY",
            "(value) => string",
    ...
    [
      ...
      p(
        ...
        [
          prop(
            "children",
            "(item: ChartLegendItem) => ReactNode",
      ...
      p(
        ...
        [
          prop(
            "aria-label",
            "string",
            "Concise text alternative naming the instrument and period.",
          ),
          prop("yMin / yMax", "number", "Optional finite vertical scale bounds."),
          prop("yTickCount", "number", "Visible vertical-axis tick count; defaults to five."),
          prop(
  ...
  common(
    ...
    [
      ...
      p("ChartTable", "table", "Native table composed from the same labelled coordinates."),
      p(
        "ChartTooltip",
        "content",
  ...
  common(
    ...
    [
      p(
        ...
        [
          ...
          prop(
            "formatValue",
            "(value: number) => string",
            "Formats endpoint ticks and table cells.",
          ),
        ],
      ),
      p("ChartTitle", "label", "Native figcaption that visibly names the figure."),
      ...
      p("ChartTable", "table", "Native table with exact start and end values."),
      p(
        "ChartTooltip",
        "content",
    ...
    "Charts are descriptive content and do not create form values.",
    ["bar-chart", "open-to-close-chart", "table"],
  ),
  common(
    "boxplot-chart",
    "Box Plot Chart",
    ...
    [
      p(
        ...
        [
          ...
          prop(
            "formatValue",
            "(value: number) => string",
            "Formats summary ticks and table cells.",
          ),
        ],
      ),
      p("ChartTitle", "label", "Native figcaption that visibly names the figure."),
      ...
      p("ChartTable", "table", "Native table with every five-number summary."),
      p(
        "ChartTooltip",
        "content",
    ...
    "Charts are descriptive content and do not create form values.",
    ["candlestick-chart", "dumbbell-chart", "table"],
  ),
  common(
    "open-to-close-chart",
    "Open-to-close Chart",
    ...
    [
      p(
        ...
        [
          ...
          prop(
            ...
            "string",
            "Accessible and table labels for each endpoint.",
          ),
          prop(
            "formatX / formatY",
            "(value) => string",
      ...
      p("ChartTable", "table", "Native table with exact open and close values."),
      p(
        "ChartTooltip",
        "content",
  ...
  common(
    ...
    [
      p(
        ...
        [
          ...
          prop(
            "formatValue",
            "(value: number) => string",
            "Formats numeric ticks and table cells.",
          ),
        ],
      ),
      p("ChartTitle", "label", "Native figcaption that visibly names the figure."),
      ...
      p("ChartTable", "table", "Native table with exact category values."),
      p(
        "ChartTooltip",
        "content",
        "Optional floating value label shown on hover or focus.",
    ...
    "Charts are descriptive content and do not create form values.",
    ["bar-chart", "dumbbell-chart", "table"],
  ),
  common(
    "stacked-bar-chart",
    "Stacked Bar Chart",
    ...
    [
      p(
        ...
        [
          ...
          prop(
            "categoryLabel / valueLabel",
            "string",
            "Visible category and numeric axis headings.",
          ),
          prop(
            "formatValue",
            "(value: number) => string",
      ...
      p("ChartTable", "table", "Native table composed with segment columns and totals."),
      p(
        "ChartTooltip",
        "content",
    ...
    "Charts are descriptive content and do not create form values.",
    ["bar-chart", "stacked-column-chart", "table"],
  ),
  common(
    "stacked-column-chart",
    "Stacked Column Chart",
    ...
    "Charts are descriptive content and do not create form values.",
    ["column-chart", "stacked-bar-chart", "table"],
  ),
  common(
    "histogram",
    "Histogram",
    ...
    [
      p(
        ...
        [
          prop(
            "values",
            "readonly number[]",
            "Finite observations grouped into ranges by HistogramPlot.",
          ),
      ...
      p(
        ...
        [
          ...
          prop(
            "children",
            "(bin: HistogramBinState) => ReactNode",
            "Custom bin renderer receiving its range, count, and geometry.",
          ),
          prop("bin", "HistogramBinState", "Bin state passed from the plot to HistogramBin."),
        ],
      ),
      ...
      p(
        "ChartTable",
        "table",
        "Native table containing underlying observations or exact bin counts.",
      ),
      p(
        "ChartTooltip",
        "content",
    ...
    [
      ...
      p(
        ...
        [
          ...
          prop(
            "children",
            "(cell: HeatmapCellState) => ReactNode",
            "Custom cell renderer receiving its coordinate, value, and geometry.",
          ),
          prop("cell", "HeatmapCellState", "Cell state passed from the plot to HeatmapCell."),
        ],
      ),
      p("ChartDescription", "feedback", "Visible prose summarizing the strongest pattern."),
      p("ChartTable", "table", "Native matrix table with explicit row and column headers."),
      p(
        "ChartTooltip",
        "content",
  ...
  common(
    ...
    [
      ...
      p("ChartTable", "table", "Native table listing each source, target, and exact flow value."),
      p(
        "ChartTooltip",
        "content",
