...
export function ComponentOutline({ doc, className, compact = false }: ComponentOutlineProps) {
  ...
  if (compact) {
    return (
      <details
        className={`rounded-xl border border-zinc-950/10 p-4 dark:border-white/10 ${className ?? ""}`}
      >
