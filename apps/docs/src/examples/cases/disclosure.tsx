...
export function Example() {
  return (
    <Disclosure className="docs-disclosure max-w-xs rounded border border-zinc-950/10 p-3 dark:border-white/10">
      <DisclosureTrigger className="group flex cursor-pointer list-none items-center justify-between gap-2 text-base font-medium text-zinc-900 select-none sm:text-sm dark:text-zinc-100 [&::-webkit-details-marker]:hidden">
        What is included?
        <ChevronDownIcon
