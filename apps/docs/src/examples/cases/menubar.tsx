...
export function Example() {
  return (
    ...
    >
      <Menu>
        <MenuTrigger className="rounded px-3 py-2.5 text-base text-zinc-800 hover:bg-zinc-100 data-open:bg-zinc-100 sm:py-2 sm:text-sm dark:text-zinc-100 dark:hover:bg-zinc-800 dark:data-open:bg-zinc-800">
          File
        </MenuTrigger>
        <MenuPopover
