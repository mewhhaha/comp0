    ...
    <div className="flex max-w-sm flex-col gap-2">
      ...
      >
        {files.map((name) => (
          ...
          >
            <GridListDragHandle className="cursor-grab rounded px-1 font-mono text-base text-zinc-400 outline-teal-600 hover:bg-zinc-950/5 hover:text-zinc-700 focus-visible:outline-2 sm:text-sm dark:text-zinc-500 dark:outline-teal-400 dark:hover:bg-white/5 dark:hover:text-zinc-200">
              ⋮⋮
            </GridListDragHandle>
